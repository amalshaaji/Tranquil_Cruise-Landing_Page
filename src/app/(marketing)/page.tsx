                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <Image
                              src={card.image}
                              alt={`${card.title} in the Alleppey backwaters`}
                              fill
              ...
              <div className="grid gap-6 lg:grid-cols-[1fr,0.9fr]">
                ...
                <div className="rounded-[1.8rem] border border-navy/10 bg-white p-6">
                  <div className="space-y-3 text-sm leading-7 text-foreground/70">
                    <p><strong className="text-foreground">Phone:</strong> <a href={BUSINESS_PHONE_LINK}>{BUSINESS_PHONE}</a></p>
                    <p><strong className="text-foreground">Location:</strong> {BUSINESS_LOCATION}</p>
                    <p><strong className="text-foreground">Hours:</strong> {BUSINESS_HOURS}</p>
                  </div>
                  <div className="mt-5 flex flex-wrap gap-3">
                    <Link href="/contact" className="inline-flex items-center justify-center rounded-xl bg-[#173247] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#234760]">
                      Enquire about Alleppey backwater stays
                    </Link>
                    <Link href={WHATSAPP_URL} className="inline-flex items-center justify-center rounded-xl border border-black/10 bg-white px-5 py-3 text-sm font-semibold text-foreground transition hover:bg-black/5">
                      WhatsApp for quick booking help
                    </Link>
                  </div>
                </div>
              </div>
                    ...
                    <div className="mt-7 grid gap-3 sm:grid-cols-2">
                      <div className="rounded-[1.6rem] border border-white/90 bg-white/85 p-5 shadow-[0_14px_32px_rgba(23,50,71,0.06)]">
                        ...
                        <div className="mt-3 flex flex-col items-start gap-1 sm:flex-row sm:items-end sm:gap-3">
                          <span className="text-4xl font-semibold tracking-tight text-navy">
                            {googleReviewData.rating.toFixed(1)}
                          </span>
                      ...
                      <div className="rounded-[1.6rem] border border-white/90 bg-[linear-gradient(180deg,#f7fbfd_0%,#edf5f8_100%)] p-5 shadow-[0_14px_32px_rgba(23,50,71,0.06)]">
                        ...
                        <div className="mt-3 text-4xl font-semibold tracking-tight text-navy">
                          {googleReviewData.reviewCount}
                        </div>
                        <p className="mt-3 text-sm leading-6 text-foreground/62">
                          Based on the current Google business listing or the
                          most recent saved review snapshot.
                        </p>
                      </div>
                    </div>
                    ) : null}
                        ...
                        {googleReviewData?.rating && googleReviewData?.reviewCount ? (
                          <div className="max-w-xs rounded-[1.4rem] border border-navy/10 bg-white/80 px-5 py-4 text-center shadow-sm backdrop-blur-sm">
                            ...
                            <div className="mt-1 text-sm text-foreground/60">
                              {googleReviewData.reviewCount} reviews
                            </div>
                          </div>
                        ) : null}
                      </div>
