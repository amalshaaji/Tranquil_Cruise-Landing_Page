...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/houseboats/5-bedroom" },
  openGraph: {
    title: "5 Bedroom Houseboat | Kerala Celebration Backwater Stay | Tranquil Cruise",
    description:
      "Five-bedroom celebration houseboat on Kerala's backwaters. Large group layout with private rooms, shared lounge, and scenic overnight cruising in Alleppey.",
