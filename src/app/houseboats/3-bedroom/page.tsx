...
const reasonsToLove = [
  {
    ...
    text: "A larger three bedroom format that gives families and small groups enough space to stay together without feeling compressed.",
  },
  {
...
const faqs = [
  {
    question: "Who is this 3 bedroom houseboat best suited for?",
    answer: "This option works especially well for extended families, small private groups, and guests who want multiple bedrooms with a more spacious shared lounge setup on the backwaters.",
  },
  {
    question: "How many guests can this houseboat comfortably host?",
    answer: "It is generally ideal for family and small-group travel. Share your guest count and preferred room setup when enquiring, and the team can guide you on the most comfortable arrangement.",
  },
  {
    question: "Does the 3 bedroom layout include private room and washroom access?",
    answer: "Yes. The format is built around multiple private sleeping rooms with washroom access, along with indoor shared lounging spaces that make overnight cruising feel easier for groups.",
  },
  {
    question: "Can we plan overnight routes or custom group stays on this boat?",
    answer: "Yes. You can share your dates, guest count, and stay preferences, and the team can help shape an overnight or custom backwater plan around this 3 bedroom houseboat.",
  },
];
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="mb-7 max-w-md text-sm leading-7 text-white/70 sm:mb-12 sm:text-lg sm:leading-relaxed">
                This option is shaped for guests who want more shared room,
                extra bedrooms, and a smoother overnight group experience
                without moving into a much larger celebration-sized boat.
              </p>
