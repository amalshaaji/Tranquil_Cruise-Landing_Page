...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/houseboats/2-bedroom" },
  openGraph: {
    title: "2 Bedroom Houseboat | Kerala Family Backwater Stay | Tranquil Cruise",
    description:
      "Spacious two-bedroom houseboat on Kerala's backwaters. Family-friendly with separate rooms, lounge, and scenic overnight cruising in Alleppey.",
